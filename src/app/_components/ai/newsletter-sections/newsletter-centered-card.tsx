    ...
    <div className={`py-16 sm:py-24`}>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Stay in the loop with Workliife!
          </h2>
          <p
          ...
          >
            Sign up for our newsletter and get the latest updates, exclusive content, and early access to new products. Don't miss out on valuable advice and money-saving tips!
          </p>
